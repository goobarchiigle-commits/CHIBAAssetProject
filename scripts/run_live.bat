...
set LOG_OUT=%LOG_DIR%\run_live_%TIMESTAMP%.log
set LOG_ERR=%LOG_DIR%\run_live_%TIMESTAMP%.err.log
...
"C:\Users\owner\AppData\Local\Programs\Python\Python312\python.exe" src\watchdog_runner.py --live --yes 1>"%LOG_OUT%" 2>"%LOG_ERR%"
