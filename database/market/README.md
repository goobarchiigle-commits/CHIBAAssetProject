...
| 最終同期日 | 2026-07-23（`src/database/sync_bulk.py` 実行・2026-07-22分まで反映） |
| 日足OHLCV/財務summary/信用/空売り | 2016-07-01 〜 最新（継続更新） |
| 分足・Tick | 2024-07-23 〜 最新（J-Quants Add-on契約の提供範囲=過去2年分のみ。これより古いデータは存在しない） |
| 指数（TOPIX/TOPIX-17業種等） | 2016-07-25 〜 最新（Standardプラン=過去10年ローリング窓） |
